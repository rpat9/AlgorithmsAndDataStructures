# Chapter-1: R-1.2: Write a short Python function, is even(k), that takes an integer value and returns True if k is even, 
...
# C-1.15: Write a Python function that takes a sequence of numbers (separated by space) and determines if all the numbers are different 
